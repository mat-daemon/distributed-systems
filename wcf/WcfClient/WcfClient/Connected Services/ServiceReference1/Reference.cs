...
/*        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICalculator/iBiggestPrime", ReplyAction="http://tempuri.org/ICalculator/iBiggestPrimeResponse")]
        int iBiggestPrime(int val1, int val2);*/
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICalculator/iBiggestPrime", ReplyAction="http://tempuri.org/ICalculator/iBiggestPrimeResponse")]
        System.Threading.Tasks.Task<KeyValuePair<int, int>> iBiggestPrimeAsync(int val1, int val2);
    }
...
/*        public int iBiggestPrime(int val1, int val2) {
            return base.Channel.iBiggestPrime(val1, val2);
        }*/
        
        public System.Threading.Tasks.Task<KeyValuePair<int, int>> iBiggestPrimeAsync(int val1, int val2) {
